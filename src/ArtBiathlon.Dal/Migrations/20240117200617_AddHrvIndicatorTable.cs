...
public class AddHrvIndicatorTable : Migration {
    public override void Up()
    {
        ...
        Execute.Sql(@"
            CREATE INDEX CONCURRENTLY IF NOT EXISTS hrv_indicator_biathlete_id
            ON hrv_indicator (biathlete_id);
        ");
    ...
    public override void Down()
    {
        ...
        Execute.Sql(@"DROP INDEX CONCURRENTLY IF EXISTS hrv_indicator_biathlete_id;");
